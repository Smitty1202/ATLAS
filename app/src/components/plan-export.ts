...
// bakes in the dark background + an ATLAS watermark and target header. The
 ...
 * bracket on a dark background, with a target-name header and ATLAS
...
export async function renderPlanPng(
  ...
  // ATLAS watermark sits top-right. A hairline divides it from the bracket.
  ctx.textAlign = "left";
